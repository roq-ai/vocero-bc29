...
import { getChatHistoryById } from 'apiSdk/chat-histories';
import { ChatHistoryInterface } from 'interfaces/chat-history';

function ChatHistoryViewPage() {
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('chat_history', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/chat-histories/edit/${id}`} passHref legacyBehavior>
                    <Button
