  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to Vocero - Your Personalized Platform to Create User-Centric Chats Based on Unique Contents. Connect, Communicate, Collaborate!"
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1577563908411-5077b6dc7624?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxjaGF0fGVufDB8fHx8MTY5NTMyMTkwNnww&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to Vocero - Your Personalized Platform to Create User-Centric Chats Based on Unique Contents. Connect, Communicate, Collaborate!`}
            </Text>
            <Box
